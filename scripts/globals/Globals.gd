...
var creatures: Dictionary = { ## dictionary for all the creatures made in the game
	...
	#},
	"bard": FigureData.new("Bard", load("res://assets/creatures/bard.png"), {"ability_scores": [12, 13, 4, 5, 12, 53], "max_hp": 30}, "A dragon's favorite")
	#"bard": {
		#"name": "Bard", 
...
var objects: Dictionary = { ## dictionary for all the objects in the game
	"wooden_chest": ObjectData.new("Wooden Chest", null, null, load("res://assets/3d_models/default_models/wooden_chest.glb"), false, "A wooden chest made of wood."),
	"bookshelf": ObjectData.new("Wizards Bookshelf", null, null, load("res://assets/3d_models/default_models/bookshelf/bookshelf.glb"), false, "A wizard's bookshelf.")
}
